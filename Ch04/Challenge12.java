	...
	public static void main(String[] args) {
		...
		if (pack != 'A' && pack != 'B' && pack != 'C') 
			...
			if (minutes < 0)
				...
				if (pack == 'A') {
					chargesB = getCharges('B', minutes);
					if (charges > chargesB)
						System.out.println("You would save $" + (charges - chargesB) + " with package B");
					chargesC =  getCharges('C', minutes);
					if (charges > chargesC)
						System.out.println("You would save $" + (charges - chargesC) + " with package C");
				} else if (pack == 'B') {
					chargesC =  getCharges('C', minutes);
					if (charges > chargesC)
						System.out.println("You would save $" + (charges - chargesC) + " with package C");
